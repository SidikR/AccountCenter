...
class ProfileController extends Controller
{
    ...
    public function edit_profile()
    {
        ...
        return view('admin.profile.edit_profile', compact('data'));
    }
    ...
    public function update_profile(Request $request, $email)
    {
        ...
        if ($update) {
            ...
            return redirect()->route('dashboard.admin.profile')->with(['success' => 'Profile Berhasil diupdate!']); // Ganti dengan rute setelah login berhasil
        } else {
            return redirect()->route('dashboard.admin.profile')->with(['fail' => 'Profile Gagal diupdate!']); // Ganti dengan rute setelah login berhasil
        }
    }
