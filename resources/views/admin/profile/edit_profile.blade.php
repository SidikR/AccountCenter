    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-10">
                ...
                <div class="card">
                    <form action="{{ route('dashboard.admin.update_profile', ['email' => $data['akun']->email]) }}"
                                ...
                                <table class="table table-lg">
                                    <tbody>
                                        ...
                                        {{-- <tr>
                                            ...
                                            <td>:</td>
                                            <td><select class="custom-select" name="role_user">
                                                    <option value="admin"
                                                        {{ $data['role_user'] == 'admin' ? 'selected' : '' }}>
                                                        Admin</option>
                                                    <option value="user"
                                                        {{ $data['role_user'] == 'user' ? 'selected' : '' }}>
                                                        User
                                                    </option>
                                                    <option value="verifikator"
                                                        {{ $data['role_user'] == 'verifikator' ? 'selected' : '' }}>
                                                        Verifikator
                                                    </option>
                                                    <option value="super_admin"
                                                        {{ $data['role_user'] == 'super_admin' ? 'selected' : '' }}>Super
                                                        Admin
                                                    </option>
                                                    <option value="bupati"
                                                        {{ $data['role_user'] == 'bupati' ? 'selected' : '' }}>
                                                        Bupati</option>
                                                    <option value="kadis"
                                                        {{ $data['role_user'] == 'kadis' ? 'selected' : '' }}>
                                                        Kepala Dinas</option>
                                                    <option value="sekdis"
                                                        {{ $data['role_user'] == 'sekdis' ? 'selected' : '' }}>
                                                        Sekretaris Dinas</option>
                                                    <option value="kabid"
                                                        {{ $data['role_user'] == 'kabid' ? 'selected' : '' }}>
                                                        Kepala Bidang</option>
                                                    <option value="kasi"
                                                        {{ $data['role_user'] == 'kasi' ? 'selected' : '' }}>
                                                        Kasi/Kasubbag</option>
                                                    <option value="staff"
                                                        {{ $data['role_user'] == 'staff' ? 'selected' : '' }}>
                                                        Staff</option>
                                                </select>
                                            </td>
                                        </tr> --}}
